...
adalah $n$-tuple $(s_1, s_2, \ldots, s_n)$ itu adalah solusi untuk masing-masing sistem *m* persamaan.  
...
*kode python untuk OBE(operasi baris elementer)*
```python
import numpy as np
